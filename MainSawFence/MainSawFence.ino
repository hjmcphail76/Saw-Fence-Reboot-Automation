...
// Specifies which motor port you have connected.
...
// Declares motor helper functions.
...
//Clearpath related helper functions:
...
bool MoveAbsolutePosition(int position) {
    ...
    Serial.print("Moving to absolute position: " + position);
